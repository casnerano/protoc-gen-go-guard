...
func Benchmark_Guard_PublicAccessMethod(b *testing.B) {
	ctx := context.Background()
	server := services.NewGuardServer()
...
func Benchmark_Guard_AuthenticatedAccessMethod(b *testing.B) {
...
func Benchmark_Guard_RoleBasedAccessMethod(b *testing.B) {
